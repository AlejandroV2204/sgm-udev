        ...
        <form action="crudRevisionControlador.php" method="GET" class="row g-3">
            ...
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label">Nombre PC:
                    <input type="text" name="descripcion_reporte" id="id_pc1" tabindex="1" class=" form-control span6"
                        value="<?php echo $row['id_pc1']; ?>" disabled> </label>
                </label>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <label for="validationDefault02" class="form-label">Descripción:
                        <input type="text" name="descripcion_reporte" id="id_reporte" tabindex="1"
                            class=" form-control span6" value="<?php echo $row['descripcion_reporte']; ?>" disabled>
                    </label>
                    </label>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-floating">
                        ...
                        <textarea class="form-control" placeholder="Deja tu observación aquí."
                            name="observacion_reporte" style="height: 100px" id="floatingTextarea"></textarea>
                        <div class="col-6">
                        </div>
                        <div class="col-12">
