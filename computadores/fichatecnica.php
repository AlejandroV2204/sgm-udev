        ...
        <div class="widget-content">
            ...
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label">Tipo graficos:
                    <input type="text" name="tipograficos" id="tipograficos" tabindex="1" class=" form-control span6"
                        value="<?php echo $row['tipo_graficos']; ?>" disabled>
                </label>
                </label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label">Estado Panel Frontal:
                    <input type="text" name="panelfrontal" id="panelfrontal" tabindex="1" class=" form-control span6"
                        value="<?php echo $row['estado_panel_frontal']; ?>" disabled>
                </label>
                </label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label">Ventiladores:
                    <input type="text" name="ventiladores" id="ventiladores" tabindex="1" class=" form-control span6"
                        value="<?php echo $row['ventiladores']; ?>" disabled>
                </label>
                </label>
            </div>
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label">Ultima pasta termica en:
                    <input type="text" name="pastatermica" id="pastatermica" tabindex="1" class=" form-control span6"
                        value="<?php echo $row['cambio_pasta_termica']; ?>" disabled>
                </label>
                </label>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label">Salidas video:
                    <input type="text" name="salidasvideo" id="salidasvideo" tabindex="1" class=" form-control span6"
                        value="<?php echo $row['salidas_video']; ?>" disabled>
                </label>
                </label>
            </div>
            <div class="col-md-4">
